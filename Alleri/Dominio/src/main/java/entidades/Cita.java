...
public class Cita {
    ...
    @ManyToOne
    @JoinColumn(name = "adeudo_actualiza_id")
    private Adeudo adeudoActualiza;
    ...
    public Adeudo getAdeudoActualiza() {
        return adeudoActualiza;
    }

    public void setAdeudoActualiza(Adeudo adeudoActualiza) {
        this.adeudoActualiza = adeudoActualiza;
    }
